        ...
        <Grid item xs={12}>
          <>
            ...
            fullWidth
                ...
                sx={{color:textcolor}}
              >
              API documentation for the React Tabs component. ... The name MuiTabs can be used when providing default props or style overrides in the theme.API documentation for the React Tabs component. ... The name MuiTabs can be used when providing default props or style overrides in the theme.API documentation for the React Tabs component. ... The name MuiTabs can be used when providing default props or style overrides in the theme.
              </Typography>
          </>
        </Grid>
        <Grid item xs={12} sm={6}>
